    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
      ...
      <div>
        ...
        <div class="flex gap-3">
          <!-- Instagram -->
          <a href="https://www.instagram.com/maujahit.id" target="_blank" rel="noopener noreferrer" aria-label="Instagram" class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors">
          ...
          <!-- TikTok -->
          <a href="https://www.tiktok.com/@maujahit.id?_r=1&_t=ZS-91WTk9M7P2P" target="_blank" rel="noopener noreferrer" aria-label="TikTok" class="w-9 h-9 bg-white/10 rounded-lg flex items-center justify-center hover:bg-white/20 transition-colors">
            <svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
              <path d="M12.525.02c1.31-.02 2.61-.01 3.91-.02.08 1.53.63 3.09 1.75 4.17 1.12 1.11 2.7 1.62 4.24 1.79v4.03c-1.44-.05-2.89-.35-4.2-.97-.57-.26-1.1-.59-1.62-.93v7.2c0 1.63-.52 3.25-1.46 4.54-1.41 1.95-3.83 3.12-6.2 3.03-2.31-.09-4.52-1.28-5.75-3.23-1.07-1.68-1.39-3.83-.81-5.72.63-2.07 2.19-3.79 4.16-4.59 1.95-.79 4.18-.73 6.07.24v4.21c-.81-.46-1.74-.63-2.65-.54-.92.09-1.79.52-2.42 1.17-.67.68-1.05 1.61-1.06 2.56-.01.99.36 1.96 1.05 2.65.65.65 1.56 1.03 2.48 1.05 1.15.02 2.27-.47 3.01-1.33.63-.73.96-1.68 1-2.66V0h-3.9z"/>
            </svg>
          </a>
          <!-- WhatsApp -->
